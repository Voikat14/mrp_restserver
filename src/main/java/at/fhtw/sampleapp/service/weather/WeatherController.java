...
import at.fhtw.sampleapp.repository.UnitOfWork;
import at.fhtw.sampleapp.repository.repository.WeatherRepository;
...
public class WeatherController extends Controller {
    ...
    // POST /weather
    public Response addWeather(String requestBody) {
        try {

            // request.getBody() => "{ \"id\": 4, \"city\": \"Graz\", ... }
            Weather weather = this.getObjectMapper().readValue(requestBody, Weather.class);
